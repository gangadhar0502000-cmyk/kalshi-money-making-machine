...
export type MmUpdateError = {
  code: 'U2.2' | 'U2.3' | 'U2.4' | 'U2.13' | 'U2.14' | 'U3.0' | 'U3.1' | 'U3.1.1' | 'U3.1.2' | 'U3.2' | 'U3.2.1' | 'U3.2.2'
  message: string
  dependency: string
}
...
function sameBooks(a: MmBookRow[], b: MmBookRow[]): boolean {
  ...
  for (let i = 0; i < a.length; i++) {
    ...
    if (
      ...
      (x.fairValue ?? null) !== (y.fairValue ?? null) ||
      (x.skewCents ?? null) !== (y.skewCents ?? null)
    ) {
      return false
    }
  }
...
export function makeUpdateError(
  message: string,
  dependency: string,
  code: 'U2.2' | 'U2.3' | 'U2.4' | 'U2.13' | 'U2.14' | 'U3.0' | 'U3.1' | 'U3.1.1' | 'U3.1.2' | 'U3.2' | 'U3.2.1' | 'U3.2.2' = 'U2.2',
): MmUpdateError {
